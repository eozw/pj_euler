...
{-
 - 11.
 -
 - In the 20Å~20 grid below, four numbers along a diagonal line have
 - been marked in red.
 -
 ...
 - direction (up, down, left, right, or diagonally) in the 20Å~20 grid?
 -}
...
{-
 - 15.
 -
 - Starting in the top left corner of a 2Å~2 grid, and only being able to
...
{-
 - 20.
 -
 - n! means n Å~ (n ? 1) Å~ ... Å~ 3 Å~ 2 Å~ 1
 -
 - For example, 10! = 10 Å~ 9 Å~ ... Å~ 3 Å~ 2 Å~ 1 = 3628800,
